...
export function SupportHub() {
  ...
  const loadConversations = useCallback(() => {
    fetch("/api/support/conversations", { cache: "no-store" })
    ...
    <div className="space-y-5">
        ...
        <CardContent className="p-4 sm:p-5">
          <div className="flex flex-wrap items-center gap-3">
            <span
              ...
              style={{ backgroundColor: AGENT_PROFILE.avatarColor }}
              aria-hidden="true"
            >
              SP
            </span>
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">{AGENT_PROFILE.displayName}</p>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[320px_1fr]">
                    ...
                    <li key={c.id}>
                      <button
                        ...
                        className={cn(
                          ...
                          c.id === activeId
                            ? "border-brand-600 bg-brand-50/70 dark:border-brand-500/50 dark:bg-brand-500/10"
          ...
          <Card className={cn("flex max-h-[70vh] min-h-[480px] flex-col", !activeId && "hidden lg:flex")}>
                  ...
                  {messages.map((m) => {
                    ...
                    return (
                      <div key={m.id} className={cn("flex", isAgent ? "justify-start" : "justify-end")}>
                        ...
                        >
                          {isAgent && (
                            <p className="mb-1 text-[11px] font-semibold text-brand-700 dark:text-brand-300">{m.senderName}</p>
                          )}
            ...
            >
              ...
              />
              <Button type="submit" size="sm" className="h-11 w-11 p-0" aria-label="Send message" disabled={!draft.trim() || msgLoading}>
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button loading={newChatSaving} onClick={() => void createConversation()}>
      ...
      >
        <form onSubmit={createConversation} className="space-y-4" noValidate>
          <Input
            label="Subject"
            placeholder="e.g. Question about a pending transfer"
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button loading={ticketSaving} onClick={() => void submitTicket()}>
